...
> Historical design record. The project was later named **PinaKey** and its crates renamed
> `pinakey-*`; this document keeps the original working names used during design.
